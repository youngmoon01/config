...
"
" Modified_by: youngmoon01(2018.06.26)
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    "DiffText
    "ErrorMsg
    call <SID>X("VertSplit", "ffffff", "ffffff", "reverse")
    call <SID>X("Folded", "ffd700", "4d4d4d", "")
    call <SID>X("FoldColumn", "d2b48c", "4d4d4d", "")
    call <SID>X("IncSearch", "", "d0d0b0", "")
    call <SID>X("Search", "", "d0d0b0", "")
    "LineNr
    call <SID>X("LineNr", "b0b0b0", "353535", "")
    call <SID>X("CursorLineNR", "e0e0e0", "202020", "")
    call <SID>X("ModeMsg", "daa520", "", "")
    call <SID>X("MoreMsg", "2e8b57", "", "")
    call <SID>X("NonText", "addbe7", "000000", "bold")
    call <SID>X("Question", "00ff7f", "", "")
    call <SID>X("SpecialKey", "9acd32", "", "")
    call <SID>X("StatusLine", "c0c0c0", "404040", "")
    call <SID>X("StatusLineNC", "404040", "c0c0c0", "")
    call <SID>X("Title", "cd5c5c", "", "")
    call <SID>X("Visual", "", "606060", "bold")
    call <SID>X("CursorLine", "", "303030", "bold")
    "VisualNOS
	...
	hi IncSearch     cterm=bold ctermbg=251
	hi Search        cterm=bold ctermbg=251
